...
internal class UserApi : IUserApi
{
    private static readonly ConcurrentDictionary<int, User> userRepository 
        = new ConcurrentDictionary<int, User>() {
            [1] = new User(1, "Динамбо",100,"Арбуз Арбуз привет"),
            [2] = new User(2, "Саня Сигма гучи", 200, "Привет шахматист был ли ты в казани"),
            [3] = new User(3, "Егор", 300, "Привет, я пока не могу смотреть стрим, так что выключай"),
        };
